...
ASSEMBLIES_PATH="/nvme/home/gomez/LinkBERT/linkbert_pipeline/gomez/assembly_rel_7/STRAIN-ISOLATE:INHABITS"
...
proteinortho -cpus=32 -p=mmseqsn -threads_per_process=2 -clean -synteny -singles -nograph -project=STRAIN_ISOLATE_INHABITS $ASSEMBLIES_PATH/*/*/*.faa
