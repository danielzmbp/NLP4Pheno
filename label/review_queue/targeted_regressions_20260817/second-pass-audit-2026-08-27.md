...
Latest export: `label/review_queue/targeted_regressions_20260817/reviewed-export-2026-08-27-second-pass.json` (`d0fea73cc472…`)
...
- Entity spans: 375; relation labels: 258
...
|---|---:|---:|---:|---:|
| {'id': 1, 'email': 'reviewer@localhost', 'first_name': '', 'last_name': ''} | 55 | 0 | 6.82 | 4.69 |
...
| STRAIN-COMPOUND:PRODUCES | 34 |
| STRAIN-COMPOUND:RESISTS | 31 |
| STRAIN-DISEASE:ASSOCIATED_WITH | 47 |
| STRAIN-ISOLATE:INHABITS | 18 |
| STRAIN-ORGANISM:INFECTS | 1 |
| STRAIN-ORGANISM:INHABITS | 28 |
| STRAIN-ORGANISM:SYMBIONT_OF | 28 |
| STRAIN-PHENOTYPE:INHIBITS | 8 |
...
| STRAIN-COMPOUND:PRODUCES | 34 | 14 |
| STRAIN-COMPOUND:RESISTS | 31 | 10 |
| STRAIN-DISEASE:ASSOCIATED_WITH | 47 | 10 |
...
| STRAIN-ORGANISM:SYMBIONT_OF | 28 | 11 |
| STRAIN-PHENOTYPE:INHIBITS | 8 | 6 |
| STRAIN-PHENOTYPE:PRESENTS | 49 | 20 |
...
- multi label spans: 0
- duplicate spans: 0
- overlapping span pairs: 17
- same entity type overlap pairs: 0
- cross entity type overlap pairs: 17
- missing relation endpoints: 0
- self relations: 0
- unlabeled relations: 0
- multi label relations: 5
