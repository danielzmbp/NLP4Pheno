...
Latest export: `label/project-10-reviewed-2026-08-27-targeted-pass.json` (`2f9ff63c3535…`)

## Summary

- Tasks: 4,184; raw active annotation records: 4,185; canonical annotations: 4,184
- Canonical annotators: {'1': 946, '2': 2893, 'Codex': 27, 'reviewer@localhost': 208, "{'id': 1, 'email': 'reviewer@localhost', 'first_name': '', 'last_name': ''}": 110}; selection policy: `ground_truth_else_latest_active`
- Entity spans: 17,808; relation labels: 7,386
...
|---|---:|---:|---:|---:|---:|
| COMPOUND | 78.2 | 80.0 | 29.6 | 192.3 | 157.3 |
| DISEASE | 20.1 | 12.4 | 29.6 | 14.4 | 38.2 |
| ISOLATE | 11.7 | 18.3 | 11.1 | 23.1 | 12.7 |
| MEDIUM | 11.6 | 15.1 | 0.0 | 18.8 | 7.3 |
| ORGANISM | 68.1 | 59.9 | 22.2 | 87.0 | 76.4 |
| PHENOTYPE | 92.6 | 63.1 | 25.9 | 59.6 | 97.3 |
| SPECIES | 32.1 | 28.4 | 25.9 | 23.1 | 39.1 |
| STRAIN | 118.1 | 129.0 | 114.8 | 143.8 | 233.6 |

### Relation labels per 100 tasks

| Label | Annotator 1 | Annotator 2 | Annotator Codex | Annotator reviewer@localhost | Annotator {'id': 1, 'email': 'reviewer@localhost', 'first_name': '', 'last_name': ''} |
|---|---:|---:|---:|---:|---:|
| ASSOCIATED_WITH | 3.2 | 3.3 | 7.4 | 5.8 | 70.0 |
| DEGRADES | 5.8 | 4.0 | 11.1 | 14.4 | 11.8 |
| GROWS_ON | 15.4 | 22.1 | 0.0 | 38.0 | 8.2 |
| INFECTS | 3.5 | 5.6 | 14.8 | 3.4 | 14.5 |
| INHABITS | 24.1 | 42.0 | 11.1 | 26.0 | 55.5 |
| INHIBITS | 35.2 | 6.6 | 7.4 | 5.3 | 38.2 |
| PRESENTS | 58.4 | 43.1 | 11.1 | 30.3 | 77.3 |
| PRODUCES | 22.9 | 21.3 | 3.7 | 79.8 | 40.0 |
| PROMOTES | 6.3 | 5.0 | 7.4 | 4.8 | 9.1 |
| RESISTS | 4.7 | 9.8 | 3.7 | 8.2 | 38.2 |
| SYMBIONT_OF | 4.9 | 1.1 | 0.0 | 0.0 | 30.9 |
...
| STRAIN-ISOLATE:INHABITS | 973 |
| STRAIN-MEDIUM:GROWS_ON | 785 |
| STRAIN-ORGANISM:INFECTS | 205 |
| STRAIN-ORGANISM:INHABITS | 511 |
| STRAIN-ORGANISM:INHIBITS | 67 |
| STRAIN-ORGANISM:SYMBIONT_OF | 112 |
| STRAIN-PHENOTYPE:ASSOCIATED_WITH | 13 |
| STRAIN-PHENOTYPE:INHIBITS | 69 |
| STRAIN-PHENOTYPE:PRESENTS | 1,701 |
...
| STRAIN-DISEASE:ASSOCIATED_WITH | 171 | 69 |
| STRAIN-DISEASE:INHIBITS | 71 | 42 |
| STRAIN-ISOLATE:INHABITS | 973 | 502 |
| STRAIN-MEDIUM:GROWS_ON | 785 | 299 |
| STRAIN-ORGANISM:INFECTS | 205 | 106 |
| STRAIN-ORGANISM:INHABITS | 511 | 252 |
| STRAIN-ORGANISM:INHIBITS | 67 | 36 |
| STRAIN-ORGANISM:SYMBIONT_OF | 112 | 53 |
| STRAIN-PHENOTYPE:INHIBITS | 69 | 49 |
| STRAIN-PHENOTYPE:PRESENTS | 1,701 | 762 |
...
- Observed typed relations absent from config: 61 patterns / 705 labels (9.5%); complete list is retained in the JSON audit
...
- multi label spans: 0
- duplicate spans: 0
- overlapping span pairs: 1026
- same entity type overlap pairs: 0
- cross entity type overlap pairs: 1026
- missing relation endpoints: 0
- self relations: 0
- unlabeled relations: 0
- multi label relations: 11
- duplicate relations: 0
- unknown result types: {}

## Export comparison

- Older: `label/project-10-reviewed-2026-08-15-taxonomy-pass.json`
- Newer: `label/project-10-reviewed-2026-08-27-targeted-pass.json`
- Added tasks: 55
- Removed tasks: 0
- Tasks with changed annotations: 0
- Changed-task categories: {}
- Signature changes: {}
