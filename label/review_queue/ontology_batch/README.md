...
that may have been missed. It contains 94 tasks with 104 suggestions:
...
2. its sentence already contains an annotated `STRAIN`;
3. the surface resolves to one eligible ontology concept;
4. the same surface has already been annotated with the suggested label in at
   least two other occurrences; and
5. basic context checks do not detect a conflicting local acronym expansion or
...
The broader audit found 634 possible omissions. The 530 lower-confidence
