...
export NLP4PHENO_ONTOLOGY_ALIASES="${NLP4PHENO_ONTOLOGY_ALIASES:-${NLP4PHENO_PROJECT}/resources/ontologies/runtime/aliases.parquet}"
export NLP4PHENO_ONTOLOGY_MANIFEST="${NLP4PHENO_ONTOLOGY_MANIFEST:-${NLP4PHENO_PROJECT}/resources/ontologies/runtime/manifest.json}"
